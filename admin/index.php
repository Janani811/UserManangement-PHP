...
<form action="adminloginpage.php" method="POST" style="background-color:white;opacity:0.8">
		...
		<input type="email" id="emailid" name="emailid" placeholder="  Type Here" required><br><br>
		<label for="pass">Password :</label><br>
		<input type="password" id="pass" name="password" placeholder="  Type Here" required><br><br><br>
